...
## Power Level Agency - Narrative Scaling System

**Second Sacred Rule**: Respect player's chosen power level. If player wants OP power fantasy (Saitama, Rimuru, Sung Jin-Woo, Deus coffee-drinking god), **embrace it**. Don't nerf, don't punish, don't force balance. Adapt narrative scale instead.

**Core Philosophy**: Power Tier ≠ Narrative Scale. They're orthogonal dimensions. Frieza (Tier 5+) fights on planets without destroying them. Goku (godlike) dies often. Saitama (Tier 5) is narratively unbeatable despite not being Tier 0. **Power imbalance matters more than absolute tier.**
